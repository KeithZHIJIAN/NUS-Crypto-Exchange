...
var AdvancedRealTimeChart = function (_a) {
    var _b = _a.width, width = _b === void 0 ? 980 : _b, _c = _a.height, height = _c === void 0 ? 610 : _c, _d = _a.autosize, autosize = _d === void 0 ? false : _d, _e = _a.symbol, symbol = _e === void 0 ? "NASDAQ:AAPL" : _e, _f = _a.interval, interval = _f === void 0 ? "1" : _f, _g = _a.range, range = _g === void 0 ? undefined : _g, _h = _a.timezone, timezone = _h === void 0 ? "UTC" : _h, _j = _a.theme, theme = _j === void 0 ? "light" : _j, _k = _a.style, style = _k === void 0 ? "1" : _k, _l = _a.locale, locale = _l === void 0 ? "en" : _l, _m = _a.toolbar_bg, toolbar_bg = _m === void 0 ? "#f1f3f6" : _m, _o = _a.enable_publishing, enable_publishing = _o === void 0 ? false : _o, _p = _a.hide_top_toolbar, hide_top_toolbar = _p === void 0 ? false : _p, _q = _a.hide_legend, hide_legend = _q === void 0 ? false : _q, _r = _a.withdateranges, withdateranges = _r === void 0 ? true : _r, _s = _a.hide_side_toolbar, hide_side_toolbar = _s === void 0 ? false : _s, _t = _a.allow_symbol_change, allow_symbol_change = _t === void 0 ? true : _t, _u = _a.save_image, save_image = _u === void 0 ? true : _u, _v = _a.details, details = _v === void 0 ? false : _v, _w = _a.hotlist, hotlist = _w === void 0 ? false : _w, _x = _a.calendar, calendar = _x === void 0 ? false : _x, _y = _a.show_popup_button, show_popup_button = _y === void 0 ? false : _y, _z = _a.popup_width, popup_width = _z === void 0 ? "600" : _z, _0 = _a.popup_height, popup_height = _0 === void 0 ? "400" : _0, _1 = _a.watchlist, watchlist = _1 === void 0 ? undefined : _1, _2 = _a.studies, studies = _2 === void 0 ? undefined : _2, _3 = _a.container_id, container_id = _3 === void 0 ? "tradingview_" + createId(5) : _3, copyrightStyles = _a.copyrightStyles, props = __rest(_a, ["width", "height", "autosize", "symbol", "interval", "range", "timezone", "theme", "style", "locale", "toolbar_bg", "enable_publishing", "hide_top_toolbar", "hide_legend", "withdateranges", "hide_side_toolbar", "allow_symbol_change", "save_image", "details", "hotlist", "calendar", "show_popup_button", "popup_width", "popup_height", "watchlist", "studies", "container_id", "copyrightStyles"]);
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        React__default['default'].createElement(Widget, { scriptHTML: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (!autosize ? { width: width } : { width: "100%" })), (!autosize ? { height: height } : { height: "100%" })), { autosize: autosize, symbol: symbol }), (!range ? { interval: interval } : { range: range })), { timezone: timezone, theme: theme, style: style, locale: locale, toolbar_bg: toolbar_bg, enable_publishing: enable_publishing, hide_top_toolbar: hide_top_toolbar, hide_legend: hide_legend, withdateranges: withdateranges, hide_side_toolbar: hide_side_toolbar, allow_symbol_change: allow_symbol_change, save_image: save_image, details: details, hotlist: hotlist, calendar: calendar }), (show_popup_button && {
            ...
            })), { watchlist: watchlist, studies: studies, container_id: container_id }), props), scriptSRC: "https://s3.tradingview.com/tv.js", containerId: container_id, type: "Widget" }),
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol, spanText: symbol + " Chart" })));
};
...
var CompanyProfile = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol + "/", spanText: symbol + " Profile" })));
};
...
var FundamentalData = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol.replace(":", "-") + "/financials-overview/", spanText: symbol + " Fundamental Data" })));
};
...
var MiniChart = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol + "/", spanText: symbol + " Rates" })));
};
...
var SymbolInfo = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol + "/", spanText: symbol + " Price Today" })));
};
...
var SymbolOverview = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbols[0][1], spanText: "" + symbols[0][1] })));
};
...
var TechnicalAnalysis = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/symbols/" + symbol.replace(":", "-") + "/technicals/", spanText: "Technical Analysis for " + symbol })));
};
...
var Timeline = function (_a) {
    ...
    return (React__default['default'].createElement("div", { id: "tradingview_widget_wrapper" },
        ...
        React__default['default'].createElement(Copyright, { copyrightStyles: copyrightStyles, href: "https://www.tradingview.com/" + href, spanText: spanText })));
};
